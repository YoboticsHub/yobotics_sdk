...
#ifndef __motor_cmd_t_hpp__
#define __motor_cmd_t_hpp__
...
int motor_cmd_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int motor_cmd_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int motor_cmd_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t motor_cmd_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* motor_cmd_t::getTypeName()
{
    return "motor_cmd_t";
}

int motor_cmd_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->contactFlag[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int motor_cmd_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->contactFlag[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int motor_cmd_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t motor_cmd_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x8b8289a4b9effae8LL;
