...
int motor_state_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->footForce[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
int motor_state_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->footForce[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0xd47ec5404e469865LL;
